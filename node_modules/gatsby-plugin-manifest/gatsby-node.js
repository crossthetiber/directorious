...
function () {
  ...
  _regenerator.default.mark(function _callee2(_ref2, pluginOptions) {
    var reporter, icon, manifest, activity, iconPath, sharpIcon, metadata, cacheMode, iconDigest;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            activity.start(); // If icons are not manually defined, use the default icon set.
            ...
            iconPath = _path.default.join("public", _path.default.dirname(manifest.icons[0].src)); //create destination directory if it doesn't exist
          ...
          case 31:
            //Write manifest
            _fs.default.writeFileSync(_path.default.join("public", "manifest.webmanifest"), JSON.stringify(manifest));
